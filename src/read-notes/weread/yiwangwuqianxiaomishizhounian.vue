  ...
  <div class="container">
    ...
    <div class="wr_macOS wr_Desktop wr_page_reader wr_whiteTheme">
      <div class="sectionListItem">
        <div class="sectionListItem_title">梦想的开端</div>
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">乘风破浪</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">我们就是用“专注、极致、口碑、快”互联网七字诀来做MIUI的。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">峰回路转</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
              MIX的成功源于小米内部浓郁的工程师文化。工程师是小米最重要的资产，为了让工程师创新和探索的火炬越烧越亮，我们设置了小米技术奖。这是小米内部的最高奖项，奖励突破性贡献的技术小组，奖金是价值一百万美元的股票。
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">国际风云</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div><div class="text">[插图]</div></div>
        </div>
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">高光时刻</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div><div class="text">[插图]</div></div>
        </div>
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">小米是谁？小米为什么而奋斗？</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div><div class="text">[插图]</div></div>
        </div>
