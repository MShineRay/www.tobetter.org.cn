  ...
  <div class="container">
    ...
    <div class="wr_macOS wr_Desktop wr_page_reader wr_whiteTheme">
      <div class="sectionListItem">
        <div class="sectionListItem_title">计算机的特征</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
              Raspberry Pi（Raspberry
              Pi也是一种卡片式微型计算机，使用者可将其与电视机或其他显示器相连，再接入键盘，就能用来学习编程。
            </div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">计算机如何工作？</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">大脑是怎样工作的？</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div><div class="text">[插图]</div></div>
        </div>
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">解决复杂的问题</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div><div class="text">[插图]</div></div>
        </div>
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">约束条件</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">面向对象程序设计（OOP）</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">除非我们为其加上某些典型特征，否则所有的对象将会一模一样。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">每创建一个对象都要为其赋予方法，这些对象才能够相互作用。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">不同的数据类型</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">条件语句</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div><div class="text">质量（此处指意义。——编者注）第一，数量第二</div></div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_divider leftIndent"></div>
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">3.如果被要牌的那位玩家手中有被要的牌，则必须交给这位要牌的玩家。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div><div class="text">7.如果玩家手中一张牌也没有了，就从池塘中拿一张。</div></div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_divider leftIndent"></div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div><div class="text">8.当池塘中没有牌时游戏结束。拥有册牌多者获胜。</div></div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">流畅的运算符</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div><div class="text">[插图]</div></div>
        </div>
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">变量</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">又到了做游戏的时间了吗？</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div><div class="text">[插图]创建自己的密码轮</div></div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">拓展阅读</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
...
export default {
  name: 'xiegeisuoyourendebianchengsiwei',
  mixins: [logCreated]
