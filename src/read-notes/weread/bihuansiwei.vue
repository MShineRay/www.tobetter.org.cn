<template>
  <div class="container">
    <h1 class="title">闭环思维</h1>
    <h5 class="author">智俊启</h5>
    <img src="/img/weread/bihuansiwei/t6_27027621.jpg" alt="written" class="written" />
    <div class="wr_macOS wr_Desktop wr_page_reader wr_whiteTheme">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">上篇 思维闭环：有始有终有反馈</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">第一章 让工作可交付，而不是“我尽力了”</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">别找借口，要找方法</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">别找借口，要找方法</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">凡事为公司考虑</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">你替公司思考过吗？</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">公司好，大家才能好</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">要多为公司考虑，让自己的利益在公司利益的基础上得以实现</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">把公司的钱当自己的钱对待</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">反复的人或事，都不可取</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">找替罪羊会让自己也变成替罪羊</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">找替罪羊会让自己也变成替罪羊</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">企业最需要的是员工解决问题的能力。员工的能力靠解决问题体现</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">有备才能无患</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">有备才能无患</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">第二章 带着建设性意见和领导沟通</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">带着建设性意见和领导沟通</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">公司是老板的，工作是自己的</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">公司是老板的，工作是自己的</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">先做好自己的工作，这是最起码的要求</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">先做好自己的工作，这是最起码的要求</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">不要只为薪水做事</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">及时汇报，别等雷劈</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">及时汇报，别等雷劈</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">让上司随时知道你在做什么</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">让上司随时知道你在做什么</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">如何跟上司有效地沟通</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">像老板一样思考，拥有更宽的视野</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">像老板一样思考，拥有更宽的视野</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">为公司着想，把工作做到极致</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">为公司着想，把工作做到极致</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">事业心决定你的事业高度</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">事业心决定你的事业高度</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">提升职业认知度，主动做好分内事</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">提升职业认知度，主动做好分内事</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">勤于思考，积极行动，才能有更大的事业成就</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">勤于思考，积极行动，才能有更大的事业成就</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">第三章 老板思维也是闭环思维</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">母鸡一天一个蛋，汤锅靠边站。公鸡一天一打鸣，主人刀下也留情。”</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">工作不相信辛苦的眼泪，只相信贡献带来的价值。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">必须做一个无人能取代的人</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">必须做一个无人能取代的人</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">闭环思维的根本原则就是反馈结果，创造价值。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">有价值才有地位，没价值就会被抛弃</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">有价值才有地位，没价值就会被抛弃</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">不在别人身上去找原因，而是先在自己的身上找问题。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">不努力也不学习，没人能救你</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">不努力也不学习，没人能救你</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">最忌讳的是“吃老本”还骄傲自大</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">最忌讳的是“吃老本”还骄傲自大</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">第一，骄傲自大、从不学习的人，是在自讨苦吃。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">不会没关系，不努力提高才是问题。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">凭什么跟老板谈判？</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">第一，没奉献出足够的价值，就没有谈判的资格。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">第二，提高能力，成为公司不可缺少的人。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">公司对你的奖罚一定有道理</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">人在企业中的价值不是恒定不变的，而是动态发展的。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">不要卖力表演，结果不会骗人</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">升职加薪的正确述说方式</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">忽略了细节，你就失去了成功的50%</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">忽略了细节，你就失去了成功的50%</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">做对十件事，抵不上做错一件事的损失</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">做对十件事，抵不上做错一件事的损失</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">一定是你做对了什么</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">能力不足可以培养，好的品质却是一种稀有的资源，必须把她留住。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">机遇也往往潜藏在细节之中</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">把小事做对，大事就有机会。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">在这个公司都做不好，跳到另一家就能做好吗？</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">想一想有没有离职的实力再做决定</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">恐惧风险，你就一定失败</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">中篇 做事靠谱：凡事有交代，件件有着落，事事有回音</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">做事靠谱：凡事有交代，件件有着落，事事有回音</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">第四章 丢掉“学生思维”，是靠谱的第一步</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">尊重不是别人给的，是自己挣的</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">尊重不是别人给的，是自己挣的</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">企图心：无欲无求，无路可走</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">人为什么会进步？那就是欲望的驱使。欲望就是上进心</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">给你机会，抓不住也无用</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">发现自己的错误很难</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">感谢那些“折磨”你的人</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">感谢那些“折磨”你的人</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">在低谷中自我修正，实现关键突破</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">在低谷中自我修正，实现关键突破</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">信心很重要</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">自信，是每一个成功人士的共同点。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">终究是你自己的原因</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">要改变，也要适应</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">第一，不能适应，就只能淘汰。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">行不行，谁说了算？</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">不屑于解决小问题，就没机会解决大问题</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">不屑于解决小问题，就没机会解决大问题</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">要想“高成”，必先“低就”</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">要想“高成”，必先“低就”</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">抱怨不如想办法</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">抱怨不如想办法</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">抱怨换来的不是同情，是轻视</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">多想办法，而不是怨天尤人</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">多想办法，而不是怨天尤人</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">必须明白参加培训的意义</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">第五章 做事靠谱，更容易被委以重任</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">只有细心，才能专业，也才能敬业。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">勿以恶小而为之，勿以善小而不为</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">勿以恶小而为之，勿以善小而不为</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">无论多小的事情，都应坚守原则</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">无论多小的事情，都应坚守原则</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">完美的结果，取决于细致的规划</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">完美的结果，取决于细致的规划</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">清楚自己要干什么，然后真的准备好</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">清楚自己要干什么，然后真的准备好</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">不是老板要求多，是你自己不用心</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">不是老板要求多，是你自己不用心</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">小问题都解决不了，又怎能承担重任？</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">小问题都解决不了，又怎能承担重任？</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">敷衍工作就是在敷衍你的前途</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">敷衍工作就是在敷衍你的前途</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">做事要有耐心</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">做好眼前的每一件工作</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">即使是小小的工作笔记，也要养成坚持的习惯</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">即使是小小的工作笔记，也要养成坚持的习惯</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">磨难是锻炼的好机会</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">第一，折磨自己，方获重生。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">第二，从细节中修习心性，从煎熬中沉淀意志。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">没有能力不可怕，没有责任心最可怕</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">没有能力不可怕，没有责任心最可怕</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">你能担多大的责任，就值得拥有多高的职位</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">“在工作中你能担多大的责任，就值得拥有多高的职位。”</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">第一，公司没有与我无关的事。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">第二，对待工作要统筹兼顾，考虑周全。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">老板的选择，是员工决定的</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">执行比想法重要</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">员工的想法与管理者的命令有冲突，决策常常执行不下去。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">行动力是“解决力”的基础</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">被动等待，是消极工作的表现</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">被动等待，是消极工作的表现</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">主动寻找机会，才能做出更好的成果</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">主动寻找机会，才能做出更好的成果</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">第二，主动还意味着对现状不要满足，要继续向上攀升。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">老板的竟见不用解释，做就是了！</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">老板的竟见不用解释，做就是了！</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">凡事无论对错，态度错了皆输</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">凡事无论对错，态度错了皆输</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">少问多做，行事才算机敏</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">少问多做，行事才算机敏</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">第二，主动出击，不要等！</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">分外事也是加分项</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">分外事也是加分项</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">“乐于助人”在不影响自己工作的前提下绝对是深受上司欣赏的加分选项。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">不要只顾眼前的利益</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">立足长远，主动参与</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">不怕犯错</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">听清指令</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">想执行到位，就要先领会到位</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">想执行到位，就要先领会到位</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">思维不要太跳跃</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">思维不要太跳跃</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">对路才是好</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">对路才是好</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">听指挥，事情还要做到位</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">听指挥，事情还要做到位</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">明确目标，行动要有针对性</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">明确目标，行动要有针对性</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">第七章 敢说“我错了”三个字，也是靠谱的表现</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">敢说“我错了”三个字，也是靠谱的表现帮人，需要条件</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">帮忙前先处理好自己的事</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">帮忙前先处理好自己的事</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">求人帮忙，也要为别人考虑</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">求人帮忙，也要为别人考虑</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">拒绝也是一种最佳选择</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">点燃自己并照亮他人</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">不要担心别人超过你</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">大家好，才是真的好</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">逃避不是办法，有事正常沟通</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">逃避不是办法，有事正常沟通</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">多沟通交流，才能解决问题</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">多沟通交流，才能解决问题</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">下篇 结果可预测：不给协作者带来风险</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">第八章 搞定自己职责范围内的一切问题</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">搞定自己职责范围内的一切问题</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">除了一个完美的结果，管理者不想看到别的任何东西。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">第一，老板是工作的发起者和结果的接收者。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">第二，工作没有业绩，再多的付出也是零。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">要结果，不要加班</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">但在管理者看来，加班是不必要的，结果却是必要而且生死攸关的。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">努力没结果，等于没努力</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">努力没结果，等于没努力</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">站在组织链顶端的人不关心下面人的努力程度，只关注努力后的结果。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">闭环：完成任务不等于就有成果</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">闭环：完成任务不等于就有成果</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">命令是前提，任务是基础，结果是反馈，三者缺一不可</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">搞定一切</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">努力工作，也要善于工作</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">胜任是标准</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">第三，改变落伍的工作方式。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">制度只注重结果，不会照顾意外</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">制度只注重结果，不会照顾意外</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">客观问题所有人都一样面对，制度只能追求结果，不可能照顾意外！</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">一个人的看法，决定了他的做法，他的做法又决定了他的活法。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">第一，根据制度要求，明确自己要完成的成果。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">老板装瞎，不是真瞎</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">面对错误，不如解决错误</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">第一时间认错，还要第一时间改错</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">第九章 努力的“姿势”再好看，没有成果也白搭</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">把最核心的信息用30秒说完</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">你必须尽快地讲明项目的完成进度、预期和产际收益以及至关重要的问题</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">简单明了，先从结果谈起</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">工作该谁干？</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">相比努力，高效更重要</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">要聪明而不是忙乱地去工作</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">要有信心提高自己的效率</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">拖沓是个坑</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">在拖拖拉拉中，你的“包裹”会变成“包袱”</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">第一，对自己的能力过度自信。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">第二，没有完成工作的愉悦感。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">第三，没有太多的对完成工作后的奖励的期望值。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">第四，容易走神。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">解决拖沓，需要有实效性的计划</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">解决拖沓，需要有实效性的计划</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">第一，做一个阶段性的短期计划并坚决执行。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">第二，将最难的工作放在上午。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">工作要有明确时间节点</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">工作要有明确时间节点</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">做事有条理，才能提高工作效率</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">做事有条理，才能提高工作效率</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">工作时间内做好本职工作，才能提升效率</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">工作时间内做好本职工作，才能提升效率</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">不要“时间倒置”，要顺从规律</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">去粗取精，善始善终</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">去粗取精，善始善终</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">第十章 不给协作者增加麻烦，是职场的一种素养</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">权力不是解决问题的唯一途径</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">功劳和责任密不可分</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">实事求是莫偏激</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">凡事没有弄清楚，就不要盲目下结论</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">凡事没有弄清楚，就不要盲目下结论</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">有些重要的事要自己干</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">越级是大忌</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">创业须慎重</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">方向不靠谱，创业就会死在起点</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">方向不靠谱，创业就会死在起点</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">每个人都是潜在的明星，但不是必然的明星</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">摆正位置，实现闭环</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">闭环思维</div>
          </div>
        </div>
      </div>
    </div>
    <!--  <footer class="footer">-->
    <!--    <img src="/img/weread/bihuansiwei/qr.png" alt="qr">-->
    <!--    <p>扫码阅读本书</p>-->
    <!--  </footer>-->
  </div>
</template>
