<template>
<div class="container">
    <h1 class="title">保持饥渴：不断获取新知识，升级底层操作能力</h1>
    <h5 class="author">Thinkers50</h5>
    <img src="/img/weread/baochijike/t6_26400280.jpg" alt="written" class="written" />
    <div class="wr_macOS wr_Desktop wr_page_reader wr_whiteTheme">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">chapter one 预见趋势：拥抱不确定性</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">预见趋势：拥抱不确定性01 唯一确定的，就是不确定性</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">02 提高快速适应环境变化的能力</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">提高快速适应环境变化的能力</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">你必须摒弃以往权力的来源，提拔那些敢于改变现状的人。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">03 数字化时代</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">05 趋势，是新时代给予小人物的机会</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">趋势，是新时代给予小人物的机会</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">08 新时代企业变革面临的两个问题及应对策略</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">chapter two 洞察组织：网络协同方向发展</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">首先，应付无边界竞争区域。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">最后，对领导力重新思考。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">10 恢复对市场的信心</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">最大化谋求利益最有效的方式便是利用市场的不完美。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">11 企业管理的人性化趋势</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">使办公场所人性化是商业操作和思维上的一个重大转变。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">12 文化是结果，不是方法</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">《文化地图：打破全球商业的隐形边界》</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">13 最简单的往往是最奏效的</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">最简单的往往是最奏效的</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">记得做到最好，因为这是唯一竞争不激烈的地方。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">《解放型管理》</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">14 战术上的勤奋和战略上的优化同步推进</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">《焦点明确的组织》</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">15 区块链革命</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">《数字资本与商务网》</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">chapter three 创新策略：理解创造性破坏</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">管理创新也意味着将闲置的点子和技术输出到公司外部。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">17 判断力是创新的驱动力</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">先进的企业还需要具备其他复杂与和人性相关的品质：判断力。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">18 要紧跟时代，万事俱备，才能成功</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">《裸露的真相：职业女性对商业和真正重要的事情的宣言》</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">《故意视而不见的大难时代》</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">19 引领创新的三种关键能力</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">20 颠覆者的“饿狼精神”</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">接着，给有独特优势的员工提供真诚的实质性奖励。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">再接着，训练人才以做未来储备。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">最后，往长远看，克服员工挑战新任务时出现的暂时失利。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">《胆识、梦想、执行力：只要你敢想，奇迹就会发生》</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">《颠覆自我：发挥颠覆性创新力量的作用》</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">21 软实力是竞争对手最难复制的</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">21 软实力是竞争对手最难复制的</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">首先，留心你的创新目的。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">第二，让“创新”成为每个人的工作。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">第四，衡量什么是有意义的。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">《隐形的优势》</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">22 不，创新救不了你，但是可恶的问题可能会</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">《潮流聚焦》</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">chapter four 打磨思维：每一种认知都自带缺陷</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">《企业的理智之旅》</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">24 深度思考：不断逼近问题的本质</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">25 十倍增长的想法</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">用旧的思维模式去解决新问题，爱因斯坦称之为“精神失常”。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">26 如何在不确定的环境下做出有效决策</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">如何在不确定的环境下做出有效决策</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">首先，警惕获得全体一致同意的想法或者候选人。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">第二，在你离任前，对你公司最优秀的管理人士进行降职。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">正确的事重复做，剩下的交给概率</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">不要试图证明自己的正确</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">挑战一：证明我们有多聪明</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">挑战二：证明我们有多么正确</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">挑战四：他们怎么不能和我一样呢</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">29 不停地逼迫自己逃离舒适区</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">不停地逼迫自己逃离舒适区</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">30 灰度认知，黑白决策</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">当今企业领导人面临的最大挑战就是数据分析对于企业决策的侵入。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">32 会赚钱，敢花钱，分好钱</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">33 要事优先</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">其次，给多样化多个尝试。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">为何不让资源在不同领域发挥最大效用？</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">chapter six 自我管理：管理自己才能影响他人</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">37 让每个员工得以选择自己的领导人</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">让每个员工得以选择自己的领导人</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">38 自我赋能</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">思想三：发挥同伴支持和训练的作用。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">思想五：玩乐和贡献，每个人都参与其中。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">思想六：高度的个人信任是拔尖团队的秘方。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">39 敢于犯正确的错误</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">[插图]年轻职业女性重视什么？</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        <div class="sectionListItem_title">42 培养全球视野，做世界型公民</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">43 从正确地做事到做正确的事</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">了不起的领导人不是搞产品创新，而是搞工厂创新。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">工厂创新是一种比喻，用来指让员工能够发挥他们的最大潜力的创新。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">44 变雇佣关系为合作关系</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">变雇佣关系为合作关系</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">45 激发潜能、搞定大事的连接思维</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">激发潜能、搞定大事的连接思维</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">46 面对复杂决定时，认真对待你的直觉思维</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">面对复杂决定时，认真对待你的直觉思维</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
        ...
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">不仅想知道顾客都买了什么，还想知道人们为什么买这些东西。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">48 培养不可替代的“唯一性”</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">49 不断获取新知识，培养超强的学习能力</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">员工才华发挥不充分的代价比浪费工资来得深远。</div>
          </div>
        </div>
      </div>
      <div class="sectionListItem">
      ...
      <div class="sectionListItem">
        <div class="sectionListItem_title">50 不忘初心，保持对成功的渴望</div>
        <div class="sectionListItem_content noteItem_content clickable">
          <span class="icon"></span>
          <div>
            <div class="text">
    ...
    <!--  <footer class="footer">-->
    <!--    <img src="/img/weread/baochijike：buduanhuoquxinzhishi，shengjidicengcaozuonengli/qr.png" alt="qr">-->
    <!--    <p>扫码阅读本书</p>-->
    <!--  </footer>-->
  </div>
</template>
