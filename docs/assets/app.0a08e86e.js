...
const _sfc_main$v = /* @__PURE__ */ defineComponent({
  setup(__props) {
    const { theme } = useData();
    const VPAlgoliaSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPAlgoliaSearchBox.0a0db5be.js"), true ? ["assets/VPAlgoliaSearchBox.0a0db5be.js","assets/plugin-vue_export-helper.8106b725.js","assets/framework.765af80f.js"] : void 0));
